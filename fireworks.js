...
function preload() {
  explosion1 = loadSound('assets/firework_explode_1.mp3');
  explosion2 = loadSound('assets/firework_explode_2.mp3');
  launch = loadSound('assets/firework_rocket_launch.mp3');
}
